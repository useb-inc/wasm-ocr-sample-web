...
function module(resourceBaseUrl) {
  ...
  var wasmBinaryFile;
  wasmBinaryFile = resourceBaseUrl + "useb_aes256.wasm";
  if (!isURL(wasmBinaryFile) && !isDataURI(wasmBinaryFile)) {
  ...
  function getBinaryPromise() {
    return _getBinaryPromise.apply(this, arguments);
  }
  function _getBinaryPromise() {
    _getBinaryPromise = _asyncToGenerator(function* () {
      if (!wasmBinary && (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER)) {
        if (typeof fetch == "function" && !isFileURI(wasmBinaryFile)) {
          try {
            var response = yield fetch(wasmBinaryFile, {
  ...
  var _useb_aes256_encrypt = Module["_useb_aes256_encrypt"] = function () {
    return (_useb_aes256_encrypt = Module["_useb_aes256_encrypt"] = Module["asm"]["h"]).apply(null, arguments);
  };
  var _useb_aes256_decrypt = Module["_useb_aes256_decrypt"] = function () {
    return (_useb_aes256_decrypt = Module["_useb_aes256_decrypt"] = Module["asm"]["i"]).apply(null, arguments);
  };
